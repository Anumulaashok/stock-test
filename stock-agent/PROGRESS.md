...
**Not yet done in Wave 5:** Screener, Global News -- both entirely unscoped this session (Screener needs new backend filtering/pagination; Global News needs new backend aggregation).
